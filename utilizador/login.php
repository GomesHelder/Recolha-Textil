    ...
    <div class="back">
        ...
        <?php 
            ...
            if (isset($_GET['email'])) {
                ...
                // Verifica se o municípe já existe
                ...
                // Dados errados
                    ...
                    <p>Se for uma Empresa clique&nbsp;<a href='login_empresa.php'>aqui</a> &nbsp;para fazer Login</p>
                    <p>Não tem conta? Faça o&nbsp;<a href='registo.php'>Registo</a></p>";<?php
                }
            // Ainda não tentou iniciar sessão
            } else {
                ?>
                <form class="form" method="get" name="login">
                    <h1>Login Munícipe</h1>
                    <label for="email">Email:</label>
                ...
                <br><br>
                <p>Se for uma Empresa clique&nbsp;<a href="login_empresa.php">aqui</a> &nbsp;para fazer Login</p>
                <p>Não tem conta? Faça o&nbsp;<a href="registo.php">Registo</a></p>
            <?php
            }
            ?>
    </div>
